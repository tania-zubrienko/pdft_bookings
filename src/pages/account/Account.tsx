                      ...
                      {classesForSelectedDay.map((cls) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className='flex items-center gap-4 shrink-0 text-xs text-ui-text-muted'>
                ...
                <div>
                  ...
                  <div className='space-y-4'>
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`w-4 h-4 text-ui-text-muted transition-transform ${pastReservationsOpen ? 'rotate-180' : ''}`}
                      />
                    </button>
